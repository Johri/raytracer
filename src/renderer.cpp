...
//    color c (l.get_ambient() * mat.get_ambient());
    ...
    double second=l.get_ambient()[1]*shap.get_material().get_ambient()[1]+l.get_defuse()[1]*(shap.get_material().get_defuse()[1]);  //*scaleproduct((normalize(l.location()), shap.get_normal("schnittpunkt mit dem shape")));
    double third=l.get_ambient()[2]*shap.get_material().get_ambient()[2]+l.get_defuse()[2]*(shap.get_material().get_defuse()[2]);  //*scaleproduct((normalize(l.location()), shap.get_normal("schnittpunkt mit dem shape"))));
